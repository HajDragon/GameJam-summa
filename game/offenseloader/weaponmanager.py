...
class WeaponManager(object):
    ...
    def loadWeaponData(self, weaponType):
        ...
        filename = TextureHelper.get_resource_path("data/weapons/{}.yaml".format(weaponName))
        ...
        filenameHitArea = TextureHelper.get_resource_path("data/weapons/{}_hitarea.ascii".format(weaponName))
        ...
        filenameHitDetect = TextureHelper.get_resource_path("data/weapons/{}_hitdetect.ascii".format(weaponName))
