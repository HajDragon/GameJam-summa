...
class CharacterAnimationManager(object):
    ...
    def readAnimation(
        ...
        filename = TextureHelper.get_resource_path("data/textures/character/{}/{}_{}.ascii".format(ct, ct, cat))
        ...
        filenameYaml = TextureHelper.get_resource_path("data/textures/character/{}/{}_{}.yaml".format(ct, ct, cat))
