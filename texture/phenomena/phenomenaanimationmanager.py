...
class PhenomenaAnimationManager(object):
    ...
    def readPhenomena(
        ...
        filename = TextureHelper.get_resource_path("data/textures/phenomena/{}.ascii".format(phenomenaName))
        animation = TextureHelper.readAnimationFile(filename)
        animation.name = phenomenaName

        filenameYaml = TextureHelper.get_resource_path("data/textures/phenomena/{}.yaml".format(phenomenaName))
